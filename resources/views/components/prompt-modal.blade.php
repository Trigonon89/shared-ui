<div
    x-data="{
        ...
        show(event) {
            ...
            this.requiredText = event.detail.requiredText ?? '';
            this.inputText    = '';
            this.error        = false;
        ...
        confirm() {
            if (this.inputText !== this.requiredText) {
                this.error = true;
                return;
            }
            this.open = false;
    ...
    @prompt-action.window="show($event)"
>
    ...
    >
        ...
        >
                    ...
                    <div class="min-w-0 w-full">
                        ...
                        <div class="mt-4">
                            <p class="text-sm text-gray-700 mb-1">
                                Type <strong x-text="requiredText"></strong> to confirm:
                            </p>
                            <input
                                type="text"
                                x-model="inputText"
                                ...
                                autocomplete="off"
                            />
                            <p x-show="error" class="mt-1 text-sm text-red-600">
            ...
            <div class="flex justify-end gap-3 px-6 py-4 bg-gray-50 rounded-b-lg">
                ...
                <x-danger-button @click="confirm()">Confirm Delete</x-danger-button>
            </div>
        </div>
    </div>
</div>
